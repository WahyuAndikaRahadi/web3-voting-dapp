...
const PageAbout = () => {
  return (
    ...
    <div className="bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="text-white my-28 flex flex-col items-center justify-center p-4 text-center max-w-3xl ">
        <h1 className="text-4xl font-extrabold mb-6 text-blue-400">About Us</h1>
        <p className="mb-6 text-lg">
          Welcome to TiedVote, the next-generation voting platform powered by blockchain technology. Our mission is to provide a secure, transparent, and efficient way for communities to make collective decisions.
        </p>
      </div>

      <div className="bg-gray-800 shadow-lg rounded-lg p-8 max-w-2xl mr-auto ml-10 mt-5 mb-40c   w-full">
        <h2 className="text-4xl font-bold mb-4 text-blue-400">Why are we actually here?</h2>
      ...
      <div className="bg-gray-800 shadow-lg rounded-lg p-8 max-w-6xl mb-20 w-full text-center">
        <h2 className="text-4xl font-bold mb-5 text-blue-400">Why choose us?</h2>
        <ul className="list-disc list-inside mb-6 text-lg mx-auto max-w-2xl">
      ...
      <div className="bg-white min-w-full flex flex-col items-center justify-center">
        <h2 className="text-5xl font-semibold my-60  text-gray-900">Blockchain Integration</h2>
        ...
        <div className="bg-gray-800 shadow-lg rounded-lg p-8 max-w-6xl mt-10 w-full">
          ...
          <p className="text-lg">
            Join us at TiedVote and be part of a revolution in how decisions are made. Your vote matters, and with our platform, you can be confident that it is counted accurately and securely.
          </p>
        </div>
      </div>
    </div>
